...
from ThreeUnderscoreParser.ThreeUnderscorePromptTemplate import (
    ThreeUnderscorePromptTemplate,
)
from ThreeUnderscoreParser.ThreeUnderscoreOutputParser import (
    ThreeUnderscoreOutputParser,
)
...
tools = [Tool(name=search.name, func=search.run, description=search.description)]
